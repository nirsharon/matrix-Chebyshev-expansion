...
f_A1 =  inv(A1^2+.25*eye(size(A1,1)));
f_A2 =  inv(A2^2+.25*eye(size(A2,1)));
f_A3 =  inv(A3^2+.25*eye(size(A3,1)));
f_A4 =  (A4^2+.25*eye(size(A4,1)))^(-1);
...
h_legend = legend('10','5,5','2,2,2,2,2','Location','best');%,'10,10');
